...
static void gfx_dxgi_init(const char *game_name, bool start_in_fullscreen, bool start_in_foreground) {
...
// idk chatgpt just made this bro
void gfx_dxgi_deinit(void) {
    // if (dxgi.swap_chain.Get() != nullptr) {
    //     dxgi.swap_chain->SetFullscreenState(FALSE, nullptr);
    //     dxgi.swap_chain->Release();
    //     dxgi.swap_chain = nullptr;
    // }
    // if (dxgi.factory.Get() != nullptr) {
    //     dxgi.factory->Release();
    //     dxgi.factory = nullptr;
    // }
