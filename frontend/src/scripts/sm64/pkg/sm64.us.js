...
var ASM_CONSTS = {
 ...
 11640724: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 11640807: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 11640876: () => { return window.innerWidth; },  
 11640906: () => { return window.innerHeight; }
};
